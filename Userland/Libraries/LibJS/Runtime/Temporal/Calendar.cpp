...
ThrowCompletionOr<Optional<CalendarMethodsRecord>> create_calendar_methods_record_from_relative_to(VM& vm, PlainDate* plain_relative_to, ZonedDateTime* zoned_relative_to, Vector<CalendarMethod> const& methods)
{
...
ThrowCompletionOr<NonnullGCPtr<Duration>> calendar_date_until(VM& vm, CalendarMethodsRecord const& calendar_record, Value one, Value two, Object const& options)
{

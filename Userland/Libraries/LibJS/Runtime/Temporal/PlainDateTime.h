...
private:
    PlainDateTime(i32 iso_year, u8 iso_month, u8 iso_day, u8 iso_hour, u8 iso_minute, u8 iso_second, u16 iso_millisecond, u16 iso_microsecond, u16 iso_nanosecond, Variant<String, NonnullGCPtr<Object>> calendar, Object& prototype);
...
ThrowCompletionOr<NonnullGCPtr<PlainDateTime>> to_temporal_date_time(VM&, Value item, Object const* options = nullptr);
...
ThrowCompletionOr<NonnullGCPtr<PlainDateTime>> create_temporal_date_time(VM&, i32 iso_year, u8 iso_month, u8 iso_day, u8 hour, u8 minute, u8 second, u16 millisecond, u16 microsecond, u16 nanosecond, Variant<String, NonnullGCPtr<Object>> const& calendar, FunctionObject const* new_target = nullptr);

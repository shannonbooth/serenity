...
ThrowCompletionOr<NonnullGCPtr<Duration>> difference_date(VM& vm, CalendarMethodsRecord const&, PlainDate const& one, PlainDate const& two, Object const& options);

...
ErrorOr<String> to_unicode_lowercase_full(StringView, Optional<StringView> const& locale = {});
ErrorOr<String> to_unicode_uppercase_full(StringView, Optional<StringView> const& locale = {});

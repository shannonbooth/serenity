...
public:
    ...
    static WebIDL::ExceptionOr<JS::NonnullGCPtr<FileReader>> construct_impl(JS::Realm&);

    // async read methods
    void read_as_array_buffer(Blob&);
    void read_as_binary_string(Blob&);
    void read_as_text(Blob&, Optional<String> const& encoding = {});
    void read_as_data_url(Blob&);
    ...
    JS::Handle<WebIDL::DOMException> error() const { return m_error; }
...
private:
    ...
    JS::Handle<Web::WebIDL::DOMException> m_error;
};

...
CSSNamespaceRule::CSSNamespaceRule(JS::Realm& realm, FlyString prefix, FlyString namespace_uri)
    : CSSRule(realm)
...
JS::NonnullGCPtr<CSSNamespaceRule> CSSNamespaceRule::create(JS::Realm& realm, FlyString prefix, FlyString namespace_uri)
{

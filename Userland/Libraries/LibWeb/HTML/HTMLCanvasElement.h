...
public:
    ...
    String to_data_url(Optional<String> const& type, Optional<double> quality) const;
    WebIDL::ExceptionOr<void> to_blob(JS::NonnullGCPtr<WebIDL::CallbackType> callback, Optional<String> const& type, Optional<double> quality);

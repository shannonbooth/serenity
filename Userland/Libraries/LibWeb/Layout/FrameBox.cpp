...
void FrameBox::prepare_for_replaced_layout()
{
    ...
    set_natural_width(dom_node().attribute(HTML::AttributeNames::width.to_deprecated_fly_string()).to_int().value_or(300));
    set_natural_height(dom_node().attribute(HTML::AttributeNames::height.to_deprecated_fly_string()).to_int().value_or(150));
}

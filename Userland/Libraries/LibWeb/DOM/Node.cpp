...
Optional<StringView> Node::first_valid_id(String const& value, Document const& document)
{
    auto id_list = value.bytes_as_string_view().split_view_if(Infra::is_ascii_whitespace);
    for (auto const& id : id_list) {

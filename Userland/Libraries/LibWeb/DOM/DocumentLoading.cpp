...
static bool build_image_document(DOM::Document& document, ByteBuffer const& data)
{
    ...
    MUST(image_element->set_attribute(HTML::AttributeNames::src.to_deprecated_fly_string(), document.url().to_deprecated_string()));
...
static bool build_video_document(DOM::Document& document)
{
    ...
    MUST(video_element->set_attribute(HTML::AttributeNames::src.to_deprecated_fly_string(), document.url().to_deprecated_string()));
    MUST(video_element->set_attribute(HTML::AttributeNames::autoplay.to_deprecated_fly_string(), DeprecatedString::empty()));
    MUST(video_element->set_attribute(HTML::AttributeNames::controls.to_deprecated_fly_string(), DeprecatedString::empty()));

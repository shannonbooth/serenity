...
public:
    ...
    Attr* get_attribute_ns(Optional<FlyString> namespace_, FlyString const& local_name, size_t* item_index = nullptr);
    Attr const* get_attribute_ns(Optional<FlyString> namespace_, FlyString const& local_name, size_t* item_index = nullptr) const;

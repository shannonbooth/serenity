...
void StyleElementUtils::update_a_style_block(DOM::Element& style_element)
{
    ...
    auto type_attribute = style_element.attribute(HTML::AttributeNames::type.to_deprecated_fly_string());
    ...
    create_a_css_style_sheet(
        ...
        "text/css"sv,
        &style_element,
        style_element.attribute(HTML::AttributeNames::media.to_deprecated_fly_string()),
        style_element.in_a_document_tree() ? style_element.attribute(HTML::AttributeNames::title.to_deprecated_fly_string()) : DeprecatedString::empty(),
        false,
        true,
        {},
        nullptr,

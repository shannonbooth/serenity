...
{
    return document.heap().allocate<Attr>(document.realm(), document, QualifiedName(MUST(FlyString::from_deprecated_fly_string(local_name)), Optional<FlyString> {}, Optional<FlyString> {}), move(value), owner_element);
}
